        ...
        <div className="card o-hidden border-0 shadow-lg my-5 w-100">
            <div className="card-body p-0 ">
                ...
                <div className="col-lg-5  d-lg-block ">
                    <img src="https://www.successmantra.in/assets/assestsnew/images/login-registration.png" style={{marginTop:"50px" ,height:"300px",width:"420px"}} class="img-fluid" alt="Responsive image"></img>
                </div>
                    <div className="col-lg-7">
                        <div className="p-3">
                            <div className="text-center">
                                <h1 className="h4 text-gray-900 mb-4">Create an Admin..!</h1>
                            </div>
